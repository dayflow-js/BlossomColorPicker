...
const frameworks = [
  {
    id: 'react',
    name: 'React',
    package: '@dayflow/blossom-color-picker-react',
    color: '#61DAFB',
    icon: (
  ...
  },
  {
    id: 'vue',
    name: 'Vue',
    package: '@dayflow/blossom-color-picker-vue',
    color: '#41B883',
    icon: (
  ...
  },
  {
    id: 'angular',
    name: 'Angular',
    package: '@dayflow/blossom-color-picker-angular',
    color: '#DD0031',
    icon: (
  ...
  },
  {
    id: 'svelte',
    name: 'Svelte',
    package: '@dayflow/blossom-color-picker-svelte',
    color: '#FF3E00',
    icon: (
...
const commandBlockClassName =
  'overflow-x-auto rounded-lg border border-[var(--color-blossom-code-border)] bg-[var(--color-blossom-code-bg)] p-4 text-sm font-medium whitespace-pre';
